	...
	config.SafetySettings = []*genai.SafetySetting{
		{
			...
			Threshold: toGenAIHarmBlockThreshold(g.opts.HarmThreshold),
		},
		{
...
func toGenAIHarmBlockThreshold(h googleai.HarmBlockThreshold) genai.HarmBlockThreshold {
	switch h {
...
func (g *Vertex) convertMessages(messages []llms.MessageContent) ([]*genai.Content, *genai.Content, error) {
...
func (g *Vertex) generateContentStream(
	ctx context.Context,
	model string,
